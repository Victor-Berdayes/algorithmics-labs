...
public class PyramidPuzzleTest {
	@Test
	public void test5() {
		boolean result = executeFromFile("src/labs/examples/branchandbound/pyramid/case5.txt");
		assertEquals(true, result);
	}
	
	@Test
	public void test15() {
		boolean result = executeFromFile("src/labs/examples/branchandbound/pyramid/case15.txt");
		assertEquals(true, result);
	}
